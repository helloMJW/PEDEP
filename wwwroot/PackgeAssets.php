...
class PackgeAssets implements SetupScript
{
    ...
    {
        $choice = 1;//$this->command->choice("Do you want to publish {$tag} files?", ['No', 'Yes', 'Overwrite', 'Ask'], $option);
    ...
    {
        $choice = 1;//$this->command->choice("Do you want to publish \"{$tag}\" files of \"{$package}\" package?", ['No', 'Yes', 'Overwrite'], 1);
