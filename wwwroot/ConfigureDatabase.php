...
class ConfigureDatabase implements SetupScript
{
    ...
    {
        $host = 'mysql';// $this->command->ask('Enter your database host.', '127.0.0.1');
    ...
    protected function askDatabaseName()
    {
        ...
        $database = 'lavalite';//$this->command->ask('Enter your database name.', 'homestead');
        return $database;
    }
    ...
    protected function askDatabaseUsername()
    {
        ...
        $username = 'root';//$this->command->ask('Enter your database username.', 'homestead');
        return $username;
    }
    ...
    {
        $databasePassword = 'root';//$this->command->secret('Enter your database password (type blank for no password).', 'blank');
