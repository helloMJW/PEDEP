    ...
    protected function createAdminUser()
    {
        try {
            $user = $this->userRepository->find($this->userRepository->create([
                'username' => 'admin',//$this->ask('Your username', 'admin'),
                'email' => 'admin@gmail.com',//$this->ask('Your email', 'admin@webed.com'),
                'password' => 'admin123',//$this->secret('Your password'),
                'display_name' => 'superadmin',//$this->ask('Your display name', 'Super Admin'),
                'first_name' => 'admin',//$this->ask('Your first name', 'Admin'),
                'last_name' => 'lastadmin',//$this->ask('Your last name', false),
            ]));
            if ($this->role) {
