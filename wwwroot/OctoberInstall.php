...
class OctoberInstall extends Command
{
    ...
    {
        $url = 'http://localhost';//$this->ask('Application URL', Config::get('app.url'));
...
*/
    ...
    {
        $result = [];
        $result['host'] = 'mysql5.6';//$this->ask('MySQL Host', Config::get('database.connections.mysql.host'));
        $result['port'] = '3306';//$this->output->ask('MySQL Port', Config::get('database.connections.mysql.port') ?: false) ?: '';
        $result['database'] = 'october';//$this->ask('Database Name', Config::get('database.connections.mysql.database'));
        $result['username'] = 'root';//$this->ask('MySQL Login', Config::get('database.connections.mysql.username'));
        $result['password'] = 'root';//$this->ask('MySQL Password', Config::get('database.connections.mysql.password') ?: false) ?: '';
        return $result;
    }
    ...
    protected function setupAdminUser()
    {
        ...
        SeedSetupAdmin::$firstName = 'jack';//$this->ask('First Name', SeedSetupAdmin::$firstName);
        SeedSetupAdmin::$lastName = 'ma';//$this->ask('Last Name', SeedSetupAdmin::$lastName);
        SeedSetupAdmin::$email = 'admin@gmail.com';//$this->ask('Email Address', SeedSetupAdmin::$email);
        SeedSetupAdmin::$login = 'admin';//$this->ask('Admin Login', SeedSetupAdmin::$login);
        SeedSetupAdmin::$password = 'admin123';//$this->ask('Admin Password', SeedSetupAdmin::$password);
