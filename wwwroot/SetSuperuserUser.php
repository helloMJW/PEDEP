...
class SetSuperuserUser implements SetupScript
{
    ...
    private function askUserEmail()
    {
        ...
        do {
            $data['email'] = 'admin@gmail.com';//$this->command->ask('Please enter email for superuser', 'superuser@lavalite.org');
    ...
    private function askUserPassword()
    {
        ...
        do {
            $data['password'] = 'admin123';//$this->command->secret("Please enter password for superuser");
